...
public class RedBabyOrderDetailVo implements Serializable {
     ...
     * 服务商品
     */
    @Mapping("redBabySrvCommdtyInfoDto")
    @com.learn.beancopy.annotation.Mapping("redBabySrvCommdtyInfoDto")
    private RedBabySrvCommdtyInfoVo redBabySrvCommdtyInfoVo;

    @Mapping("redBabySrvCommdtyInfoDtos")
    @com.learn.beancopy.annotation.Mapping("redBabySrvCommdtyInfoDtos")
    private List<RedBabySrvCommdtyInfoVo> redBabySrvCommdtyInfoVos;
    ...
    public RedBabySrvCommdtyInfoVo getRedBabySrvCommdtyInfoVo() {
        return redBabySrvCommdtyInfoVo;
    }

    public void setRedBabySrvCommdtyInfoVo(RedBabySrvCommdtyInfoVo redBabySrvCommdtyInfoVo) {
        this.redBabySrvCommdtyInfoVo = redBabySrvCommdtyInfoVo;
    }

    public List<RedBabySrvCommdtyInfoVo> getRedBabySrvCommdtyInfoVos() {
        return redBabySrvCommdtyInfoVos;
    }

    public void setRedBabySrvCommdtyInfoVos(List<RedBabySrvCommdtyInfoVo> redBabySrvCommdtyInfoVos) {
        this.redBabySrvCommdtyInfoVos = redBabySrvCommdtyInfoVos;
    }
    ...
    public String toString() {
        return "RedBabyOrderDetailVo{" +
                ...
                ", redBabySrvCommdtyInfoVo=" + redBabySrvCommdtyInfoVo +
                ", redBabySrvCommdtyInfoVos=" + redBabySrvCommdtyInfoVos +
                ", age=" + age +
                '}';
    }
}
